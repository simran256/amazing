...
<!--                 <div class="col-md-4">
        ...
        <div class="col-md-2 from-txt ">
          ...
          <input type="text" size="4" placeholder="Height" name="tmb_height" value="<?php echo $tmb_height; ?>">
             ...
             <div class="col-md-3">
                <label class="input-text">Cate/Product Brochure PDF</label>
                  <div class="form-group">
				     <?php 
						if($cat_pd_pdf_image!="") {
                    ...
                    if ($fileName != '') {
                        ...
                        $filePath = "uploads/product/cat_pd_pdf_image/" . $fileName;
                
                        if (strtolower($fileExtension) === 'pdf') {
                            echo '<i class="fa fa-file-pdf-o" style="font-size:48px;color:red"></i>';
                        } else {
                            echo '<img src="' . $filePath . '" width="50px" height="50px" alt="Uploaded Image">';
                        }
                
                        echo '<a href="removeImage5.php?id=' . $id . '&data=' . urlencode($fileName) . '" style="cursor:pointer;">Remove</a>';
                    }
                    ?>
                </div>
					<?php	}
